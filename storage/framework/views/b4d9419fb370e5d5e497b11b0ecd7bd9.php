...
<?php $__env->startSection('page-description', 'Monitor system activities and user actions'); ?>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['total_activities'] ?? 0)); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['today_activities'] ?? 0)); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['week_activities'] ?? 0)); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-orange-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['month_activities'] ?? 0)); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-indigo-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['user_logins'] ?? 0)); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e(number_format($stats['system_changes'] ?? 0)); ?></p>
                </div>
                ...
                <div class="space-y-3" id="recent-activities">
                    <?php if(isset($recentActivities) && count($recentActivities) > 0): ?>
                        <?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="activity-item border-l-4 rounded-lg p-4 bg-gray-50 severity-<?php echo e($activity['severity'] ?? 'info'); ?>">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center space-x-2 mb-2">
                                            <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                                <?php if(($activity['severity'] ?? 'info') === 'warning'): ?> bg-yellow-100 text-yellow-800
                                                <?php elseif(($activity['severity'] ?? 'info') === 'error'): ?> bg-red-100 text-red-800
                                                <?php elseif(($activity['severity'] ?? 'info') === 'critical'): ?> bg-red-200 text-red-900
                                                <?php else: ?> bg-blue-100 text-blue-800
                                                <?php endif; ?>">
                                                <?php echo e(strtoupper($activity['severity'] ?? 'info')); ?>

                                            </span>
                                            <span class="px-2 py-1 text-xs font-medium rounded bg-gray-200 text-gray-700">
                                                <?php echo e(ucfirst(str_replace('_', ' ', $activity['type'] ?? 'unknown'))); ?>

                                            </span>
                                        </div>
                                        <h3 class="text-sm font-semibold text-gray-900 mb-1"><?php echo e($activity['action'] ?? 'Unknown Action'); ?></h3>
                                        <p class="text-sm text-gray-600 mb-2"><?php echo e($activity['description'] ?? 'No description'); ?></p>
                                        <div class="flex items-center space-x-4 text-xs text-gray-500">
                                            <span class="flex items-center">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                                </svg>
                                                <?php echo e($activity['user'] ?? 'Unknown User'); ?>
                                            ...
                                            <span class="flex items-center">
                                                ...
                                                <?php echo e($activity['timestamp'] ?? 'Unknown time'); ?>
                                            ...
                                            <span class="flex items-center">
                                                ...
                                                <?php echo e($activity['ip_address'] ?? 'N/A'); ?>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-4" id="user-activities">
                    <?php if(isset($userActivities) && count($userActivities) > 0): ?>
                        <?php $__currentLoopData = $userActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="text-sm font-semibold text-gray-900"><?php echo e($user['user'] ?? 'Unknown User'); ?></h3>
                                    <span class="px-2 py-1 text-xs rounded-full 
                                        <?php if(($user['status'] ?? 'inactive') === 'active'): ?> bg-green-100 text-green-800
                                ...
                                <div class="text-xs text-gray-600 space-y-1">
                                    <p class="flex items-center">
                                        ...
                                        <?php echo e(number_format($user['activities_count'] ?? 0)); ?> activities
                                    </p>
                                    <p class="flex items-center">
                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        Last: <?php echo e($user['last_activity'] ?? 'Never'); ?>
                                    ...
                                    <p class="flex items-center">
                                        ...
                                        IP: <?php echo e($user['ip_address'] ?? 'N/A'); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\audit-trail.blade.php ENDPATH**/ ?>