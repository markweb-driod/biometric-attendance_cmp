            ...
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <span class="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-xs font-semibold tracking-wide border border-white/20">
                        <?php echo e(\Carbon\Carbon::now()->format('l, jS F Y')); ?>

                    </span>
                </div>
                <h1 class="text-3xl md:text-4xl font-bold mb-2">
                    Welcome back, <?php echo e(explode(' ', Auth::guard('hod')->user()->user->name ?? 'HOD')[0]); ?>! 👋
                </h1>
                <p class="text-green-100 text-lg opacity-90 max-w-2xl">
                    Here's what's happening in your department today. You have <span class="font-bold text-white"><?php echo e($atRiskStudents ?? 0); ?> items</span> requiring attention.
                </p>
            </div>
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('hod.monitoring.students')); ?>" class="px-6 py-3 bg-white text-green-700 font-bold rounded-xl shadow-lg hover:shadow-xl hover:bg-green-50 transition-all transform hover:-translate-y-0.5 whitespace-nowrap">
                    View Students
                </a>
            </div>
        </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:border-green-100 transition-all group">
        ...
        <div>
            ...
            <h3 class="text-3xl font-bold text-gray-800 mt-1" data-stat="students"><?php echo e($totalStudents ?? 0); ?></h3>
        </div>
    </div>
    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:border-green-100 transition-all group">
        ...
        <div>
            ...
            <h3 class="text-3xl font-bold text-gray-800 mt-1" data-stat="lecturers"><?php echo e($totalLecturers ?? 0); ?></h3>
        </div>
    </div>
    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:border-green-100 transition-all group">
        ...
        <div>
            ...
            <h3 class="text-3xl font-bold text-gray-800 mt-1" data-stat="courses"><?php echo e($activeCourses ?? 0); ?></h3>
        </div>
    </div>
    ...
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white hover:border-green-100 transition-all group">
        <div class="flex items-start justify-between mb-4">
            ...
            ?>
            <span class="flex items-center text-xs font-medium px-2 py-1 rounded-lg <?php echo e($avgTrend); ?>">
                <?php echo e(number_format($averageAttendance ?? 0, 1)); ?>%
            </span>
        </div>
        <div>
            <p class="text-gray-500 text-sm font-medium">Avg Attendance</p>
            <h3 class="text-3xl font-bold text-gray-800 mt-1" data-stat="attendance"><?php echo e(number_format($averageAttendance ?? 0, 1)); ?>%</h3>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <a href="<?php echo e(route('hod.management.course-assignment.index')); ?>" class="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-green-200 transition-all group">
            ...
            <a href="<?php echo e(route('hod.monitoring.courses')); ?>" class="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all group">
            ...
            <a href="<?php echo e(route('hod.report.attendance')); ?>" class="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-purple-200 transition-all group">
            ...
            <a href="<?php echo e(route('hod.settings.general')); ?>" class="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-gray-300 transition-all group">
        ...
        <div class="bg-red-50 rounded-2xl p-6 border border-red-100 flex items-start gap-4">
            ...
            <div class="flex-grow">
                ...
                <p class="text-red-600 mb-3">
                    <span class="font-bold"><?php echo e($atRiskStudents); ?> students</span> in your department have fallen below the 75% attendance threshold.
                </p>
                <a href="<?php echo e(route('hod.monitoring.students', ['filter' => 'risk'])); ?>" class="inline-flex items-center text-sm font-semibold text-red-700 hover:text-red-800 hover:underline">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentActivities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors">
                        <div class="flex items-start gap-3">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 <?php echo e($activity['status'] === 'completed' ? 'bg-green-100 text-green-600' : 'bg-blue-100 text-blue-600'); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                            </div>
                            <div>
                                <h5 class="font-semibold text-gray-800 text-sm"><?php echo e($activity['course']); ?></h5>
                                <p class="text-xs text-gray-500 mb-1"><?php echo e($activity['lecturer']); ?> &bull; <?php echo e($activity['time']); ?></p>
                                <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide <?php echo e($activity['status'] === 'completed' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'); ?>">
...
<script>
    ...
    setInterval(() => {
        fetch('<?php echo e(route("hod.api.dashboard-stats")); ?>')
            .then(res => res.json())
            .then(data => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('hod.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\hod\dashboard.blade.php ENDPATH**/ ?>