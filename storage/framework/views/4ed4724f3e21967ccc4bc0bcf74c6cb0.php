...
<body>
    ...
    <div class="content">
        ...
        <div class="info-box">
            ...
            <p><strong>Password Changed At:</strong> <?php echo e($changedAt->format('F j, Y \a\t g:i A')); ?></p>
        </div>
...
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\emails\password-reset-success.blade.php ENDPATH**/ ?>