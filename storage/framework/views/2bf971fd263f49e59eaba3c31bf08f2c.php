...
<div class="max-w-md mx-auto p-6 mt-8 bg-white rounded-lg shadow border border-green-100">
    ...
    <form method="POST" action="<?php echo e(route('superadmin.2fa.confirm')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-4">
        <a href="<?php echo e(route('superadmin.settings')); ?>" class="text-sm text-gray-600 hover:text-gray-800">Cancel</a>
    </div>
</div>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\two-factor\setup.blade.php ENDPATH**/ ?>