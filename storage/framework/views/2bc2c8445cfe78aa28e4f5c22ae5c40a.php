...
<?php $__env->startSection('page-description', 'View and manage students enrolled in your courses'); ?>
...
<div class="max-w-7xl w-full mx-auto px-2 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                <div class="text-right">
                    <div class="text-2xl font-bold text-green-600"><?php echo e($students->count()); ?></div>
                    <div class="text-sm text-gray-500">Total Students</div>
                </div>
                <div class="text-right">
                    <div class="text-2xl font-bold text-blue-600"><?php echo e(count($studentsByCourse)); ?></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <?php $__currentLoopData = $courseStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courseName => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900 truncate"><?php echo e($courseName); ?></h3>
                <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full"><?php echo e($stats['course_code']); ?></span>
            </div>
            <div class="space-y-2">
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Students:</span>
                    <span class="font-semibold text-gray-900"><?php echo e($stats['total_students']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Class:</span>
                    <span class="text-sm text-gray-700"><?php echo e($stats['class_name']); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="sm:w-48">
                ...
                <select id="course-filter" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <?php $__currentLoopData = $courseStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courseName => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($courseName); ?>"><?php echo e($courseName); ?> (<?php echo e($stats['course_code']); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="sm:w-48">
                ...
                <select id="level-filter" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <?php $__currentLoopData = $students->pluck('academicLevel.name')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="text-sm text-gray-500">
                Showing <span id="showing-count"><?php echo e($students->count()); ?></span> of <?php echo e($students->count()); ?> students
            </div>
        </div>
        ...
        <div class="hidden md:block overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="students-table" class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="student-row" data-course="<?php echo e($student->classrooms->first()->course->course_name ?? 'Unknown'); ?>" data-level="<?php echo e($student->academicLevel->name ?? ''); ?>">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <div class="h-10 w-10 rounded-full bg-green-100 flex items-center justify-center">
                                        <span class="text-sm font-medium text-green-800"><?php echo e(substr($student->user->full_name, 0, 2)); ?></span>
                                    </div>
                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($student->user->full_name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($student->user->email); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-mono text-gray-900"><?php echo e($student->matric_number); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($student->classrooms->first()->course->course_name ?? 'N/A'); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($student->classrooms->first()->course->course_code ?? 'N/A'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-semibold bg-blue-100 text-blue-800 rounded-full"><?php echo e($student->academicLevel->name ?? 'N/A'); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($student->department->name ?? 'N/A'); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button onclick="viewStudentDetails(<?php echo e($student->id); ?>)" class="text-green-600 hover:text-green-900 mr-3">View Details</button>
                            <button onclick="viewStudentAttendance(<?php echo e($student->id); ?>)" class="text-blue-600 hover:text-blue-900">Attendance</button>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
        ...
        <div class="md:hidden space-y-4" id="mobile-students">
            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="student-card bg-gray-50 rounded-lg p-4 border border-gray-200" data-course="<?php echo e($student->classrooms->first()->course->course_name ?? 'Unknown'); ?>" data-level="<?php echo e($student->academicLevel->name ?? ''); ?>">
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center">
                        ...
                        <div>
                            <div class="font-medium text-gray-900"><?php echo e($student->user->full_name); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($student->matric_number); ?></div>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-medium text-gray-900"><?php echo e($student->classrooms->first()->course->course_name ?? 'N/A'); ?></div>
                        <div class="text-xs text-gray-500"><?php echo e($student->academicLevel->name ?? 'N/A'); ?></div>
                    </div>
                </div>
                <div class="flex justify-between items-center">
                    <div class="text-sm text-gray-600"><?php echo e($student->department->name ?? 'N/A'); ?></div>
                    <div class="space-x-2">
                        <button onclick="viewStudentDetails(<?php echo e($student->id); ?>)" class="text-green-600 hover:text-green-900 text-sm">Details</button>
                        <button onclick="viewStudentAttendance(<?php echo e($student->id); ?>)" class="text-blue-600 hover:text-blue-900 text-sm">Attendance</button>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
let allStudents = <?php echo json_encode($students, 15, 512) ?>;
...
<?php echo $__env->make('layouts.lecturer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\lecturer\students.blade.php ENDPATH**/ ?>