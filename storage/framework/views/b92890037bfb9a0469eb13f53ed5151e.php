...
<?php $__env->startSection('page-description', 'Manage your account and preferences'); ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3">
                        <?php if($has2FA): ?>
                            <form action="<?php echo e(route('lecturer.2fa.disable')); ?>" method="POST" class="flex-1">
                                <?php echo csrf_field(); ?>
                                <div class="space-y-4">
                                    <div>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('lecturer.2fa.setup')); ?>" class="flex-1 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold text-center transition-colors flex items-center justify-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.lecturer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\lecturer\settings.blade.php ENDPATH**/ ?>