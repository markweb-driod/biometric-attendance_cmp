<?php $__env->startSection('title', 'Academic Structure'); ?>
<?php $__env->startSection('page-title', 'Academic Structure'); ?>
<?php $__env->startSection('page-description', 'Manage departments, courses, academic levels, and classrooms'); ?>
...
<div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-6" x-data="{ activeTab: 'departments' }" x-init="setTimeout(() => { if (activeTab === 'classrooms') { loadClassrooms(); window.classroomsTabInitialized = true; } }, 500)">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center stat-card">
            ...
            <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['departments'] ?? 0); ?></div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center stat-card">
            ...
            <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['courses'] ?? 0); ?></div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center stat-card">
            ...
            <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['academic_levels'] ?? 0); ?></div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center stat-card">
            ...
            <div class="text-2xl font-bold text-gray-900"><?php echo e($stats['classrooms'] ?? 0); ?></div>
                        ...
                        <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                                <div class="flex-shrink-0">
                                    <?php if($activity['icon'] === 'building'): ?>
                                        <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                        </svg>
                                    <?php elseif($activity['icon'] === 'book'): ?>
                                        <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                        </svg>
                                    <?php elseif($activity['icon'] === 'chalkboard'): ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\academic-structure.blade.php ENDPATH**/ ?>