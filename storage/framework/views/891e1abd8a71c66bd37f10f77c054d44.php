...
<body>
    ...
    <div class="content">
        ...
        <div class="session-details">
            ...
            <p><strong>User Type:</strong> <?php echo e(ucfirst($session->user_type)); ?></p>
            <p><strong>Full Name:</strong> <?php echo e($session->full_name); ?></p>
            <p><strong>Identifier:</strong> <?php echo e($session->identifier); ?></p>
            <?php if($session->department_name): ?>
                <p><strong>Department:</strong> <?php echo e($session->department_name); ?></p>
            <?php endif; ?>
        </div>

        <div class="session-details">
            <h3 style="margin-top: 0;">Session Details:</h3>
            <p><strong>Login Time:</strong> <?php echo e($session->login_at->format('F j, Y \a\t g:i A')); ?></p>
            <p><strong>Session ID:</strong> <?php echo e(substr($session->session_id, 0, 20)); ?>...</p>
        ...
        <div class="session-details">
            ...
            <p><strong>IP Address:</strong> <?php echo e($session->ip_address); ?></p>
            <p><strong>Device Type:</strong> <?php echo e(ucfirst($session->device_type ?? 'Unknown')); ?></p>
            <p><strong>Operating System:</strong> <?php echo e($session->os ?? 'Unknown'); ?></p>
            <p><strong>Browser:</strong> <?php echo e($session->browser ?? 'Unknown'); ?></p>
            <?php if($session->country): ?>
                <p><strong>Location:</strong> <?php echo e($session->city ?? ''); ?><?php echo e($session->city ? ', ' : ''); ?><?php echo e($session->country); ?></p>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\emails\login-notification.blade.php ENDPATH**/ ?>