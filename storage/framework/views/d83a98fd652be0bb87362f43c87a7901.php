...
<?php endif; ?>
    ...
    <nav class="w-full bg-white/80 backdrop-blur-md shadow-lg border-b border-green-200 px-2 sm:px-8 py-2 sm:py-4">
        <div class="flex flex-row items-center justify-between w-full">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-green-700 hover:text-green-600 font-semibold">Back to Login</a>
        </div>
    </nav>
        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-green-200">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Enter the 6-digit OTP sent to your <?php echo e($user_type == 'superadmin' ? 'email' : 'email or phone'); ?></p>
                </div>
                ...
                <!-- Form -->
                <form method="POST" action="<?php echo e(route('password.verify-otp.submit')); ?>" 
                      class="space-y-6"
                ...
                <!-- Resend OTP -->
                <form method="POST" action="<?php echo e(route('password.resend-otp')); ?>" 
                      x-data="{ loading: false }"
                      @submit="loading = true; window.dispatchEvent(new CustomEvent('spinner', { detail: { show: true } }));">
                    <?php echo csrf_field(); ?>
                    <button 
                ...
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('password.forgot')); ?>" class="text-green-600 hover:text-green-700 font-semibold text-sm">
                        ← Back to Forgot Password
                    </a>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(session('flash_message')): ?>
                window.dispatchEvent(new CustomEvent('toast', { 
                    detail: { 
                        message: '<?php echo e(session('flash_message')); ?>', 
                        type: '<?php echo e(session('flash_type', 'success')); ?>' 
                    } 
                }));
...
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\auth\verify-otp.blade.php ENDPATH**/ ?>