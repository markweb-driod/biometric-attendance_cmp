<?php $__env->startSection('content'); ?>
  <div class="w-full max-w-sm md:max-w-md mx-auto p-0 sm:p-4 mt-4 mb-6">
    <div class="bg-white rounded-2xl shadow-lg border-t-4 border-green-400 px-3 py-4 sm:px-5 sm:py-6 flex flex-col items-center w-full" style="min-height:unset;height:auto;box-shadow:0 2px 16px rgba(34,197,94,0.08);">
      ...
      <form id="register-face-form" class="space-y-4 w-full hidden" enctype="multipart/form-data" method="POST" action="<?php echo e(route('student.register-face')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\student\register_face_backup.blade.php ENDPATH**/ ?>