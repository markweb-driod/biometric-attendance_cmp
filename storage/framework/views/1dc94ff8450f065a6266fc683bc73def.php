...
<?php $__env->startSection('header', 'Two-Factor Authentication'); ?>
...
<div class="max-w-md mx-auto py-6 sm:px-6 lg:px-8">
    <div class="bg-white shadow-xl rounded-xl border-l-4 border-orange-500 p-8">
        ...
        <form method="POST" action="<?php echo e(route('hod.two-factor.verify')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('hod.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\hod\two-factor\verify.blade.php ENDPATH**/ ?>