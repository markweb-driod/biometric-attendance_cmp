...
<?php $__env->startSection('page-description', 'View details and manage this class'); ?>
...
<div class="w-full min-h-screen px-2 sm:px-6 lg:px-12 py-8 bg-gradient-to-br from-green-50 via-white to-green-100">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-3 mb-2">
                <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center text-2xl font-bold text-green-600 shadow">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none"/><text x="12" y="16" text-anchor="middle" font-size="10" fill="currentColor"><?php echo e(strtoupper(substr($class->course_code,0,2))); ?></text></svg>
                </div>
                <div>
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-white leading-tight"><?php echo e($class->course_code); ?> - <?php echo e($class->class_name); ?></h2>
                    <div class="text-base text-green-50 font-medium mt-1">Class Details <span class="mx-2 text-white/40">|</span> <span class="font-semibold">Level <?php echo e($class->level); ?></span></div>
                </div>
            </div>
            <div class="flex flex-wrap gap-x-6 gap-y-1 mt-2">
                <div class="text-sm text-green-50">Schedule: <span class="font-semibold text-white"><?php echo e($class->schedule ?? '-'); ?></span></div>
                <div class="text-sm text-green-50">Description: <span class="font-semibold text-white"><?php echo e($class->description ?? '-'); ?></span></div>
                <div class="text-sm text-green-50">Lecturer: <span class="font-semibold text-white"><?php echo e($class->lecturer->name ?? '-'); ?></span></div>
            </div>
        </div>
        <div class="flex flex-col gap-2 items-end">
            <?php if($activeSession): ?>
                <div class="bg-white rounded-xl px-5 py-3 text-center shadow flex flex-col items-center min-w-[120px]">
                    ...
                    <div class="font-mono text-xl text-green-900 tracking-wider mb-1" id="attendance-code"><?php echo e($activeSession->code); ?></div>
            ...
            <?php else: ?>
                <div class="bg-gray-100 rounded-xl px-5 py-3 text-center shadow flex flex-col items-center min-w-[120px]">
                    ...
                    <div class="font-mono text-xl text-gray-900 tracking-wider mb-1"><?php echo e($class->pin); ?></div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div class="bg-white rounded-2xl shadow-xl border-2 border-green-200 px-8 py-8 text-center transform transition-transform duration-200 hover:scale-105 flex flex-col items-center">
            ...
            <div class="text-3xl font-extrabold text-green-700 count-up" data-count="<?php echo e($class->students->count()); ?>">0</div>
        </div>
        <div class="bg-white rounded-2xl shadow-xl border-2 border-green-100 px-8 py-8 text-center transform transition-transform duration-200 hover:scale-105 flex flex-col items-center">
            ...
            <div class="text-3xl font-extrabold text-green-900 count-up" data-count="<?php echo e($attendances->where('status', 'present')->count()); ?>">0</div>
        </div>
        <div class="bg-white rounded-2xl shadow-xl border-2 border-red-100 px-8 py-8 text-center transform transition-transform duration-200 hover:scale-105 flex flex-col items-center">
            ...
            <div class="text-3xl font-extrabold text-red-900 count-up" data-count="<?php echo e($class->students->count() - $attendances->where('status', 'present')->count()); ?>">0</div>
        </div>
        <div class="bg-white rounded-2xl shadow-xl border-2 border-green-100 px-8 py-8 text-center transform transition-transform duration-200 hover:scale-105 flex flex-col items-center">
            ...
            <div class="text-3xl font-extrabold text-green-700 count-up" data-count="<?php echo e($class->students->count() > 0 ? round(($attendances->where('status', 'present')->count() / $class->students->count()) * 100) : 0); ?>">0</div>
        </div>
    </div>
    <!-- Tabs -->
        ...
        <div id="students-section">
            ...
            <?php else: ?>
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 gap-2">
                    <h3 class="text-base font-semibold">Enrolled Students (<?php echo e($class->students->count()); ?>)</h3>
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm">
                    <table id="students-table" class="min-w-full text-xs sm:text-sm divide-y divide-gray-200 mb-2">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <?php $__currentLoopData = $studentPaginated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-blue-50 transition">
                                    <td class="px-3 py-2 whitespace-nowrap font-medium text-gray-900"><?php echo e($student->full_name); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap text-gray-700"><?php echo e($student->matric_number); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap text-gray-700"><?php echo e($student->level); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap text-gray-700"><?php echo e($student->department); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                    <div class="flex justify-between items-center py-2">
                        <div class="text-xs text-gray-500">Page <?php echo e($studentPage); ?> of <?php echo e($studentLastPage); ?></div>
                        <div class="flex gap-2">
                            <?php if($studentPage > 1): ?>
                                <a href="?student_page=<?php echo e($studentPage - 1); ?>&attendance_page=<?php echo e($attendancePage); ?>" class="px-2 py-1 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 text-xs">Previous</a>
                            <?php endif; ?>
                            <?php if($studentPage < $studentLastPage): ?>
                                <a href="?student_page=<?php echo e($studentPage + 1); ?>&attendance_page=<?php echo e($attendancePage); ?>" class="px-2 py-1 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 text-xs">Next</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div id="attendance-section" style="display:none;">
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm">
                <table id="attendance-table" class="min-w-full text-xs sm:text-sm divide-y divide-gray-200 mb-2">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        <?php $__currentLoopData = $attPaginated; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-green-50 transition">
                                <td class="px-3 py-2 whitespace-nowrap font-medium text-gray-900"><?php echo e($a->student->full_name ?? '-'); ?> (<?php echo e($a->student->matric_number ?? '-'); ?>)</td>
                                <td class="px-3 py-2 whitespace-nowrap text-gray-700"><?php echo e($a->captured_at ? $a->captured_at->format('Y-m-d H:i') : '-'); ?></td>
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold <?php echo e($a->status === 'present' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'); ?>">
                ...
                <div class="flex justify-between items-center py-2">
                    <div class="text-xs text-gray-500">Page <?php echo e($attendancePage); ?> of <?php echo e($attLastPage); ?></div>
                    <div class="flex gap-2">
                        <?php if($attendancePage > 1): ?>
                            <a href="?student_page=<?php echo e($studentPage); ?>&attendance_page=<?php echo e($attendancePage - 1); ?>" class="px-2 py-1 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 text-xs">Previous</a>
                        <?php endif; ?>
                        <?php if($attendancePage < $attLastPage): ?>
                            <a href="?student_page=<?php echo e($studentPage); ?>&attendance_page=<?php echo e($attendancePage + 1); ?>" class="px-2 py-1 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 text-xs">Next</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
function copyPin() {
    const pin = '<?php echo e($class->pin); ?>';
...
<?php echo $__env->make('layouts.lecturer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\lecturer\class_detail.blade.php ENDPATH**/ ?>