...
<?php $__env->startSection('title', 'Attendance Monitoring Dashboard'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.attendance-monitoring.charts.attendance-bar-chart','data' => ['chartId' => 'attendance-bar-chart','title' => 'Daily/Weekly Attendance Comparison','height' => 400]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['chart-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('attendance-bar-chart'),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Daily/Weekly Attendance Comparison'),'height' => 400]); ?>
...
<script>
    ...
    function fetchAttendance() {
        ...
        axios.get('<?php echo e(route("attendance-monitoring.filter")); ?>', {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\attendance-monitoring\dashboard.blade.php ENDPATH**/ ?>