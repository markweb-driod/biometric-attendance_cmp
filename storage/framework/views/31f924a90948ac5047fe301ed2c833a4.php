                           ...
                           <?php endif; ?>
                            ...
                            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                                ...
                                <div class="mt-4 text-center">
                                    <a href="<?php echo e(route('password.forgot')); ?>" class="text-sm text-green-600 hover:text-green-700 font-semibold transition-colors duration-200 hover:underline">
                                        Forgot Password?
                                    </a>
                                </div>
                            </form>
...
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\auth\unified-login.blade.php ENDPATH**/ ?>