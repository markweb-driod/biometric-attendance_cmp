...
<head>
    ...
    <title><?php echo e(config('app.name', 'NSUK Biometric Attendance')); ?></title>
...
<body class="bg-gray-50 flex flex-col min-h-screen font-sans antialiased text-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between relative">
            ...
            <div class="flex items-center flex-shrink-0">
                <a href="/" class="flex items-center group">
                    <img src="/images/cropped-nsuk_logo-300x300-1.png" alt="NSUK Logo" class="h-10 w-10 sm:h-12 sm:w-12 object-contain rounded-full shadow-md group-hover:scale-105 transition-transform duration-300 mr-3">
            ...
            >
                ...
                <a href="<?php echo e(route('student.attendance-capture')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base font-semibold rounded-lg shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-green-300">
                ...
                <a href="<?php echo e(route('student.register-face')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base font-semibold rounded-lg shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Other Links -->
                <a href="<?php echo e(route('about')); ?>" class="w-full sm:w-auto text-center sm:text-left block px-4 py-2 hover:text-green-700 hover:bg-green-50 sm:hover:bg-transparent font-medium transition-all rounded">About</a>
                <a href="<?php echo e(route('contact')); ?>" class="w-full sm:w-auto text-center sm:text-left block px-4 py-2 hover:text-green-700 hover:bg-green-50 sm:hover:bg-transparent font-medium transition-all rounded">Contact</a>
            </div>
        </div>
    </nav>

    <!-- Main Content -->
    <main class="flex-1 flex flex-col items-center w-full px-2 sm:px-4 pt-32 sm:pt-40 pb-4 relative">
        ...
        <div class="w-full flex flex-col items-center mt-2 sm:mt-4">
            <div class="w-full max-w-lg sm:max-w-xl bg-gradient-to-br from-white via-green-50 to-green-100 rounded-2xl shadow-lg border border-green-100 p-2 sm:p-6 mt-2 sm:mt-4" style="backdrop-filter: blur(0.5px);">
    ...
    <footer class="w-full bg-white/90 backdrop-blur-sm border-t border-green-200 py-4 text-center text-sm text-gray-600 font-medium" style="font-family: 'Inter', 'Montserrat', Arial, sans-serif;">
        ...
        <div>&copy; <?php echo e(date('Y')); ?> All rights reserved. | Department of Computer Science</div>
    ...
    <?php echo $__env->make('components.spinner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <script defer src="/js/vendor/alpine.min.js"></script>
    
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\layout.blade.php ENDPATH**/ ?>