...
<?php $__env->startSection('page-description', 'Monitor and export attendance for all classes and levels'); ?>
...
<div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between bg-green-500 rounded-lg px-6 py-3 shadow mb-6">
        ...
        <div class="flex gap-2 mt-3 md:mt-0">
            <a href="<?php echo e(route('superadmin.attendance.audit.export')); ?>" class="px-4 py-2 bg-white text-green-600 border border-green-600 rounded-lg font-medium hover:bg-green-50 hover:text-green-700 transition shadow">Export CSV</a>
        </div>
    </div>
    <!-- Stats Cards -->
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\attendance.blade.php ENDPATH**/ ?>