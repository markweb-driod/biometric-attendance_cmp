...
<?php $__env->startSection('title', 'Student Attendance Monitoring'); ?>
            ...
            <form id="filterForm" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select id="performance_filter" name="performance_filter" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                        <?php $__currentLoopData = $filterOptions['performance_filters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php echo e($filters['performance_filter'] == $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="risk_level" name="risk_level" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                        <?php $__currentLoopData = $filterOptions['risk_levels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php echo e($filters['risk_level'] == $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="per_page" name="per_page" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                        <option value="10" <?php echo e($filters['per_page'] == 10 ? 'selected' : ''); ?>>10</option>
                        <option value="15" <?php echo e($filters['per_page'] == 15 ? 'selected' : ''); ?>>15</option>
                        <option value="25" <?php echo e($filters['per_page'] == 25 ? 'selected' : ''); ?>>25</option>
                        <option value="50" <?php echo e($filters['per_page'] == 50 ? 'selected' : ''); ?>>50</option>
                        <option value="100" <?php echo e($filters['per_page'] == 100 ? 'selected' : ''); ?>>100</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="sort_by" name="sort_by" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                        <option value="average_attendance_rate" <?php echo e($filters['sort_by'] == 'average_attendance_rate' ? 'selected' : ''); ?>>Attendance Rate</option>
                        <option value="student_name" <?php echo e($filters['sort_by'] == 'student_name' ? 'selected' : ''); ?>>Student Name</option>
                        <option value="matric_number" <?php echo e($filters['sort_by'] == 'matric_number' ? 'selected' : ''); ?>>Matric Number</option>
                        <option value="academic_level" <?php echo e($filters['sort_by'] == 'academic_level' ? 'selected' : ''); ?>>Academic Level</option>
                        <option value="courses_enrolled" <?php echo e($filters['sort_by'] == 'courses_enrolled' ? 'selected' : ''); ?>>Courses Enrolled</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="sort_order" name="sort_order" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                        <option value="desc" <?php echo e($filters['sort_order'] == 'desc' ? 'selected' : ''); ?>>Descending</option>
                        <option value="asc" <?php echo e($filters['sort_order'] == 'asc' ? 'selected' : ''); ?>>Ascending</option>
                    </select>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e($attendanceAnalysis['total_students'] ?? 0); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e(number_format($attendanceAnalysis['average_attendance'] ?? 0, 1)); ?>%</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e(count($attendanceAnalysis['at_risk_students'] ?? [])); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e($attendanceAnalysis['risk_analysis']['high_risk'] ?? 0); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select id="timePeriodFilter" name="time_period" class="px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 text-sm bg-white">
                            <option value="all" <?php echo e(($filters['time_period'] ?? 'all') == 'all' ? 'selected' : ''); ?>>All Time</option>
                            <option value="semester" <?php echo e(($filters['time_period'] ?? 'all') == 'semester' ? 'selected' : ''); ?>>Current Semester</option>
                            <option value="live" <?php echo e(($filters['time_period'] ?? 'all') == 'live' ? 'selected' : ''); ?>>Live View (Today)</option>
                        </select>
                    </div>
                    ...
                    <div class="flex items-center gap-2" id="weekFilterContainer">
                        ...
                        <select id="weekFilter" name="week" class="px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 text-sm bg-white">
                            ...
                            <?php for($i = 1; $i <= 14; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(($filters['week'] ?? '') == $i ? 'selected' : ''); ?>>Week <?php echo e($i); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                <div class="flex space-x-2">
                        <a href="<?php echo e(route('hod.monitoring.students.chart', 'attendance')); ?>?<?php echo e(http_build_query($filters)); ?>" target="_blank" class="inline-flex items-center px-3 py-2 border border-green-300 rounded-lg text-sm font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200" aria-label="View chart in fullscreen">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex items-center gap-2">
                            ...
                            <select id="performanceViewMode" name="performance_view_mode" class="px-2 py-1 border border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 text-xs bg-white">
                                <option value="aggregated" <?php echo e(($filters['performance_view_mode'] ?? 'aggregated') == 'aggregated' ? 'selected' : ''); ?>>Aggregated</option>
                                <option value="individual" <?php echo e(($filters['performance_view_mode'] ?? 'aggregated') == 'individual' ? 'selected' : ''); ?>>Individual</option>
                            </select>
                        </div>
                    <a href="<?php echo e(route('hod.monitoring.students.chart', 'performance')); ?>?<?php echo e(http_build_query($filters)); ?>" target="_blank" class="inline-flex items-center px-2 py-1 border border-green-300 rounded-lg text-xs font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200" aria-label="View student performance chart in fullscreen">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('hod.monitoring.students.chart', 'risk')); ?>?<?php echo e(http_build_query($filters)); ?>" target="_blank" class="inline-flex items-center px-2 py-1 border border-green-300 rounded-lg text-xs font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200" aria-label="View risk analysis chart in fullscreen">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"></path>
                        </svg>
                    </a>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="text-sm text-gray-500">
                    Showing <?php echo e($pagination->firstItem() ?? 0); ?> to <?php echo e($pagination->lastItem() ?? 0); ?> of <?php echo e($pagination->total()); ?> results
                </div>
                <?php endif; ?>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortTable('student_name')">
                                <div class="flex items-center space-x-1">
                                    <span>Student</span>
                                    <?php if($filters['sort_by'] == 'student_name'): ?>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortTable('matric_number')">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <?php if($filters['sort_by'] == 'matric_number'): ?>
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    <?php endif; ?>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortTable('academic_level')">
                                <div class="flex items-center space-x-1">
                                    <span>Level</span>
                                    <?php if($filters['sort_by'] == 'academic_level'): ?>
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    <?php endif; ?>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortTable('average_attendance_rate')">
                                <div class="flex items-center space-x-1">
                                    ...
                                    <?php if($filters['sort_by'] == 'average_attendance_rate'): ?>
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    <?php endif; ?>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortTable('courses_enrolled')">
                                <div class="flex items-center space-x-1">
                                    <span>Courses</span>
                                    <?php if($filters['sort_by'] == 'courses_enrolled'): ?>
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    <?php endif; ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $studentMetrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($student['student_name']); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($student['matric_number']); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($student['academic_level']); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($student['average_attendance_rate']); ?>%</div>
                                    <div class="ml-2 w-16 bg-gray-200 rounded-full h-2">
                                        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($student['average_attendance_rate']); ?>%"></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($student['courses_enrolled']); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($student['risk_level'] === 'Low Risk'): ?> bg-green-100 text-green-800
                                    <?php elseif($student['risk_level'] === 'Medium Risk'): ?> bg-yellow-100 text-yellow-800
                                    <?php else: ?> bg-red-100 text-red-800
                                    <?php endif; ?>">
                                    <?php echo e($student['risk_level']); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($student['performance_rating'] === 'Excellent'): ?> bg-green-100 text-green-800
                                    <?php elseif($student['performance_rating'] === 'Good'): ?> bg-blue-100 text-blue-800
                                    <?php elseif($student['performance_rating'] === 'Average'): ?> bg-yellow-100 text-yellow-800
                                    <?php elseif($student['performance_rating'] === 'Poor'): ?> bg-orange-100 text-orange-800
                                    <?php else: ?> bg-red-100 text-red-800
                                    <?php endif; ?>">
                                    <?php echo e($student['performance_rating']); ?>
            ...
            <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                <div class="flex-1 flex justify-between sm:hidden">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e($pagination->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Previous
                        </a>
                    <?php endif; ?>
                    
                    <?php if($pagination->hasMorePages()): ?>
                        <a href="<?php echo e($pagination->nextPageUrl()); ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Next
                        </a>
                    <?php else: ?>
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Showing
                            <span class="font-medium"><?php echo e($pagination->firstItem() ?? 0); ?></span>
                            to
                            <span class="font-medium"><?php echo e($pagination->lastItem() ?? 0); ?></span>
                            of
                    ...
                    <div>
                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e($pagination->previousPageUrl()); ?>" class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
                                </a>
                            ...
                            <!-- Next Page Link -->
                            <?php if($pagination->hasMorePages()): ?>
                                <a href="<?php echo e($pagination->nextPageUrl()); ?>" class="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const studentChartConfig = <?php echo json_encode($studentChartData, 15, 512) ?>;
    const studentPerformanceChartConfig = <?php echo json_encode($studentPerformanceChartData, 15, 512) ?>;
    const riskChartConfig = <?php echo json_encode($riskChartData, 15, 512) ?>;
    ...
    function updateCourseAttendanceChart() {
        ...
        fetch('<?php echo e(route("hod.monitoring.api.students.chart-data")); ?>?' + new URLSearchParams(formData))
    ...
    function updateStudentPerformanceChart() {
        ...
        fetch('<?php echo e(route("hod.monitoring.api.students.metrics")); ?>?' + new URLSearchParams(formData))
            .then(response => response.json())
            .then(data => {
    ...
    if (searchForm) {
        ...
        window.location.href = '<?php echo e(route("hod.monitoring.students")); ?>?' + params.toString();
    });
    }
    ...
    if (clearSearchBtn) {
        clearSearchBtn.addEventListener('click', function() {
            ...
            window.location.href = '<?php echo e(route("hod.monitoring.students")); ?>';
        });
    }
    ...
    if (exportDataBtn) {
        exportDataBtn.addEventListener('click', function() {
            ...
            const params = new URLSearchParams(formData);
            window.open('<?php echo e(route("hod.monitoring.api.students.export")); ?>?' + params.toString(), '_blank');
        });
    }
});
...
function sortTable(column) {
    const currentSort = '<?php echo e($filters["sort_by"] ?? ""); ?>';
    const currentOrder = '<?php echo e($filters["sort_order"] ?? "desc"); ?>';
...
<?php echo $__env->make('hod.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\hod\monitoring\students.blade.php ENDPATH**/ ?>