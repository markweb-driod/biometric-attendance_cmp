...
<?php $__env->startSection('title', 'System Audit Logs & Monitoring'); ?>
<?php $__env->startSection('page-title', 'System Audit Logs'); ?>
<?php $__env->startSection('page-description', 'Monitor all system activities with advanced analytics and tracking'); ?>
...
function systemAuditApp() {
    return {
        ...
        auditLogs: <?php echo json_encode($auditLogsItems, 15, 512) ?>,
        pagination: <?php echo json_encode($paginationData, 15, 512) ?>,
        stats: <?php echo json_encode($auditStats, 15, 512) ?>,
        securityAlerts: <?php echo json_encode($securityAlerts, 15, 512) ?>,
        departmentActivitySummary: <?php echo json_encode($departmentActivitySummary, 15, 512) ?>,
        activityCharts: <?php echo json_encode($activityCharts, 15, 512) ?>,
        filterOptions: <?php echo json_encode($filterOptions, 15, 512) ?>,
        ...
        initCharts() {
            ...
            if (dailyCtx) {
                const dailyData = <?php echo json_encode($activityCharts['daily'], 15, 512) ?>;
            ...
            if (userTypeCtx) {
                const userTypeData = <?php echo json_encode($activityCharts['by_user_type'], 15, 512) ?>;
            ...
            if (actionCtx) {
                const actionData = <?php echo json_encode($activityCharts['by_action'], 15, 512) ?>;
            ...
            if (severityCtx) {
                const severityData = <?php echo json_encode($activityCharts['by_severity'], 15, 512) ?>;
        ...
        applyFilters() {
            ...
            window.location.href = '<?php echo e(route("superadmin.audit.index")); ?>?' + params.toString();
        },
        ...
        async exportData() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("superadmin.audit.api.export")); ?>?' + params.toString());
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\audit\index.blade.php ENDPATH**/ ?>