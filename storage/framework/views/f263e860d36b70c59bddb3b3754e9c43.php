...
<div class="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
    ...
    <div class="fixed top-4 right-4 z-50">
        <a href="<?php echo e(route('login')); ?>" class="flex items-center space-x-2 bg-white/90 backdrop-blur-md px-4 py-2.5 rounded-xl shadow-lg border border-green-100 text-green-700 font-bold hover:bg-green-50 hover:scale-105 transition-all duration-200">
    ...
    async function syncPendingItems() {
        ...
        getAllRequest.onsuccess = async () => {
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                try {
                    const response = await fetch('<?php echo e(url('api/student/capture-attendance')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views/student/attendance_capture.blade.php ENDPATH**/ ?>