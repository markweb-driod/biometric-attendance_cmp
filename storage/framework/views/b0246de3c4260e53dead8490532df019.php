...
<body>
    ...
    <div class="content">
        <?php if($isSuperadminNotification): ?>
        ...
        <div class="info-box">
            ...
            <div class="user-info">
                <p><strong>User Type:</strong> <?php echo e(ucfirst($userType)); ?></p>
                <p><strong>Identifier:</strong> <?php echo e($identifier); ?></p>
                <p><strong>User Name:</strong> <?php echo e($userData['name']); ?></p>
                <p><strong>User Email:</strong> <?php echo e($userData['email']); ?></p>
            </div>
            <p><strong>Request Time:</strong> <?php echo e($notifiedAt->format('F j, Y \a\t g:i A')); ?></p>
            <?php if($ipAddress): ?>
        ...
        <div class="info-box">
            ...
            <ol>
                <li>Check your <?php echo e($userType == 'superadmin' ? 'email' : 'email or phone'); ?> for the 6-digit OTP code</li>
...
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\emails\password-reset-attempt.blade.php ENDPATH**/ ?>