        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-green-200">
                ...
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('login')); ?>" class="text-green-600 hover:text-green-700 font-semibold text-sm">
                        ← Back to Login
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>