<?php $__env->startSection('title', 'Client API Documentation'); ?>
<?php $__env->startSection('page-title', 'Client API Documentation'); ?>
...
<div class="w-full px-2 py-10 space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-green-200 p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-green-50 border-l-4 border-green-500 p-4">
                ...
                <pre class="bg-gray-800 text-green-400 p-4 rounded-lg overflow-x-auto text-sm"><code>curl -X GET "<?php echo e(url('api/v1/eligibility/student/STU001')); ?>" \
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-green-200 p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="border border-gray-200 rounded-lg p-5 hover:border-green-400 transition">
                ...
                <pre class="bg-gray-900 text-green-400 p-3 rounded text-sm overflow-x-auto mb-3"><code><?php echo e(url('api/v1/eligibility/health')); ?></code></pre>
                <details class="mt-3">
  ...
  "current_academic_year": "2024/2025"
            ...
            <div class="border border-gray-200 rounded-lg p-5 hover:border-green-400 transition">
                ...
                <pre class="bg-gray-900 text-green-400 p-3 rounded text-sm overflow-x-auto mb-2"><code><?php echo e(url('api/v1/eligibility/student/{matricNumber}')); ?></code></pre>
                ...
                <details class="mt-2">
                    ...
                    <div class="mt-2 space-y-2">
                        <div>
                            ...
                            <pre class="bg-gray-900 text-green-400 p-2 rounded text-xs overflow-x-auto"><code>fetch('<?php echo e(url('api/v1/eligibility/student/STU001')); ?>', {
...
.then(data => console.log(data));</code></pre>
                        ...
                        <div>
                            ...
                            <pre class="bg-gray-900 text-green-400 p-2 rounded text-xs overflow-x-auto"><code>$response = file_get_contents('<?php echo e(url('api/v1/eligibility/student/STU001')); ?>', 
...
response = requests.get(
  '<?php echo e(url('api/v1/eligibility/student/STU001')); ?>',
  headers={'X-API-Key': 'your_api_key'}
)
print(response.json())</code></pre>
            ...
            <div class="border border-gray-200 rounded-lg p-5 hover:border-green-400 transition">
                ...
                <pre class="bg-gray-900 text-green-400 p-3 rounded text-sm overflow-x-auto mb-2"><code><?php echo e(url('api/v1/eligibility/student/{matricNumber}/course/{courseId}')); ?></code></pre>
                <div class="flex flex-wrap gap-2 mb-3">
  ...
  "course": {
    ...
    "threshold": 75
            ...
            <div class="border border-gray-200 rounded-lg p-5 hover:border-green-400 transition">
                ...
                <pre class="bg-gray-900 text-green-400 p-3 rounded text-sm overflow-x-auto mb-2"><code><?php echo e(url('api/v1/eligibility/student/{matricNumber}/courses')); ?></code></pre>
            </div>
            ...
            <div class="border border-gray-200 rounded-lg p-5 hover:border-green-400 transition">
                ...
                <pre class="bg-gray-900 text-green-400 p-3 rounded text-sm overflow-x-auto mb-2"><code><?php echo e(url('api/v1/eligibility/bulk')); ?></code></pre>
                <details class="mt-3">
                    <summary class="cursor-pointer text-sm font-semibold text-blue-600 hover:text-blue-800">View Request Example</summary>
                    <pre class="bg-gray-50 p-3 rounded mt-2 text-sm overflow-x-auto"><code>POST <?php echo e(url('api/v1/eligibility/bulk')); ?>
...

{
  ...
  "detailed": false
            ...
            <div class="border border-gray-200 rounded-lg p-5 hover:border-green-400 transition">
                ...
                <pre class="bg-gray-900 text-green-400 p-3 rounded text-sm overflow-x-auto mb-2"><code><?php echo e(url('api/v1/eligibility/student/{matricNumber}/semester/{semester}/academic-year/{academicYear}')); ?></code></pre>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\api-keys\documentation.blade.php ENDPATH**/ ?>