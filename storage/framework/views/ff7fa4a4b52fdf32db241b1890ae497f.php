...
<?php $__env->startSection('title', 'Course & Staff Monitoring'); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e($performanceAnalysis['total_courses'] ?? 0); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e(number_format($performanceAnalysis['average_performance'] ?? 0, 1)); ?>%</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e(count($performanceAnalysis['top_performers'] ?? [])); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900" style="font-family: 'Montserrat', sans-serif;"><?php echo e(count($performanceAnalysis['low_performers'] ?? [])); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-6 mb-6 border-l-4 border-green-300">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="<?php echo e(route('hod.monitoring.courses.chart', 'performance')); ?>?<?php echo e(http_build_query($filters)); ?>" target="_blank" class="inline-flex items-center px-3 py-1 border border-green-300 rounded-lg text-sm font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200" aria-label="View chart in fullscreen">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('hod.monitoring.courses.chart', 'lecturer')); ?>?<?php echo e(http_build_query($filters)); ?>" target="_blank" class="inline-flex items-center px-2 py-1 border border-green-300 rounded-lg text-xs font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200" aria-label="View lecturer performance chart in fullscreen">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('hod.monitoring.courses.chart', 'distribution')); ?>?<?php echo e(http_build_query($filters)); ?>" target="_blank" class="inline-flex items-center px-2 py-1 border border-green-300 rounded-lg text-xs font-medium text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200" aria-label="View performance distribution chart in fullscreen">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"></path>
                        </svg>
                    </a>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $coursePerformance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($course['course_code']); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($course['course_name']); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($course['lecturer_name']); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($course['staff_id']); ?></div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($course['average_attendance_rate']); ?>%</div>
                                    <div class="ml-2 w-16 bg-gray-200 rounded-full h-2">
                                        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($course['average_attendance_rate']); ?>%"></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($course['conducted_sessions']); ?>/<?php echo e($course['total_sessions']); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($course['punctuality_score']); ?>%
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($course['performance_rating'] === 'Excellent'): ?> bg-green-100 text-green-800
                                    <?php elseif($course['performance_rating'] === 'Good'): ?> bg-blue-100 text-blue-800
                                    <?php elseif($course['performance_rating'] === 'Average'): ?> bg-yellow-100 text-yellow-800
                                    <?php else: ?> bg-red-100 text-red-800
                                    <?php endif; ?>">
                                    <?php echo e($course['performance_rating']); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        // Parse chart data
        const courseChartData = <?php echo json_encode($courseChartData); ?>;
        const lecturerChartData = <?php echo json_encode($lecturerChartData); ?>;
        const distributionChartData = <?php echo json_encode($distributionChartData); ?>;
    ...
    document.getElementById('filterForm').addEventListener('submit', function(e) {
        ...
        window.location.href = '<?php echo e(route("hod.monitoring.courses")); ?>?' + params.toString();
    });

    // Clear filters
    document.getElementById('clearFilters').addEventListener('click', function() {
        document.getElementById('filterForm').reset();
        window.location.href = '<?php echo e(route("hod.monitoring.courses")); ?>';
    });
...
<?php echo $__env->make('hod.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\hod\monitoring\courses.blade.php ENDPATH**/ ?>