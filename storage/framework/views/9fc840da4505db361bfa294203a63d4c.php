...
<body>
    ...
    <div class="content">
        ...
        <p>This is to inform you of your attendance grade for <strong><?php echo e($classroom->class_name); ?></strong> (<?php echo e($classroom->course->course_name ?? 'N/A'); ?>).</p>
        
        <div class="grade-box">
            <div class="grade"><?php echo e($grade); ?></div>
        ...
        <div class="stats">
            <div class="stat-row">
                ...
                <span><?php echo e($attendance['total_sessions']); ?></span>
            </div>
            <div class="stat-row">
                <span><strong>Sessions Attended:</strong></span>
                <span><?php echo e($attendance['total_present']); ?></span>
            </div>
            <div class="stat-row">
                <span><strong>Attendance Percentage:</strong></span>
                <span><?php echo e($attendance['percentage']); ?>%</span>
            </div>
        </div>
    ...
    <div class="footer">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> Nasarawa State University, Keffi. All rights reserved.</p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\emails\grade_notification.blade.php ENDPATH**/ ?>