...
<?php $__env->startSection('page-description', 'Manage your courses and class schedules'); ?>
...
<div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-6" id="stats-cards">
        <div class="bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl shadow-lg p-5 flex flex-col items-center justify-center text-white relative overflow-hidden">
            ...
            <div class="text-3xl font-extrabold mb-1 z-10"><?php echo e($classes->count()); ?></div>
        ...
        <div class="bg-gradient-to-br from-green-400 to-green-600 rounded-xl shadow-lg p-5 flex flex-col items-center justify-center text-white relative overflow-hidden">
            ...
            <div class="text-3xl font-extrabold mb-1 z-10"><?php echo e($classes->where('is_active', true)->count()); ?></div>
        ...
        <div class="bg-gradient-to-br from-purple-400 to-purple-600 rounded-xl shadow-lg p-5 flex flex-col items-center justify-center text-white relative overflow-hidden">
            ...
            <div class="text-3xl font-extrabold mb-1 z-10"><?php echo e($classes->sum(fn($c) => $c->students->count())); ?></div>
        ...
        <div class="bg-gradient-to-br from-orange-400 to-orange-600 rounded-xl shadow-lg p-5 flex flex-col items-center justify-center text-white relative overflow-hidden">
            ...
            <div class="text-3xl font-extrabold mb-1 z-10"><?php echo e($classes->count() ? round($classes->where('is_active', true)->count() / $classes->count() * 100) : 0); ?>%</div>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="relative bg-white border-l-4 border-green-500 shadow-xl rounded-2xl p-6 flex flex-col justify-between hover:shadow-2xl transition-shadow duration-200">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <h3 class="text-xl font-extrabold text-gray-900"><?php echo e($cls->course->course_code ?? 'N/A'); ?></h3>
                        <p class="text-base text-gray-600"><?php echo e($cls->class_name); ?></p>
                        <div class="flex gap-2 mt-2">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-green-50 text-green-700">Level: <?php echo e($cls->course->academicLevel->name ?? 'N/A'); ?></span>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-green-50 text-green-700">Students: <?php echo e($cls->students->count()); ?></span>
                        </div>
                    </div>
                </div>
                <div class="flex items-center justify-between mt-4">
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($cls->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                            <?php echo e($cls->is_active ? 'Active' : 'Inactive'); ?>

                        </span>
                    </div>
                    <div class="flex gap-2">
                        <a href="/lecturer/classes/<?php echo e($cls->id); ?>" class="bg-green-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-green-700 transition">View</a>
                        <button onclick="editClass('<?php echo e($cls->id); ?>')" class="bg-gray-200 text-gray-700 text-sm font-semibold px-4 py-2 rounded-lg hover:bg-gray-300 transition">Edit</button>
                        <button onclick="deleteClass('<?php echo e($cls->id); ?>')" class="bg-red-100 text-red-700 text-sm font-semibold px-4 py-2 rounded-lg hover:bg-red-200 transition">Delete</button>
                    </div>
                </div>
            </div>
...
<?php if(isset($lecturer)): ?>
    const lecturer = {
        id: <?php echo e($lecturer->id); ?>,
        staff_id: '<?php echo e($lecturer->staff_id); ?>',
        name: '<?php echo e($lecturer->user->full_name); ?>',
        department: '<?php echo e($lecturer->department->name ?? 'N/A'); ?>'
    };
...
<?php echo $__env->make('layouts.lecturer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\lecturer\classes.blade.php ENDPATH**/ ?>