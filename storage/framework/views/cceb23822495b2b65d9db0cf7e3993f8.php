<?php $__env->startSection('title', 'Student Face Registration Management'); ?>
<?php $__env->startSection('page-title', 'Student Face Registration Management'); ?>
...
<div class="w-full px-2 py-10 space-y-8">
  <div class="flex flex-col md:flex-row md:items-end gap-4 mb-4">
    ...
    <div class="flex gap-2">
      ...
      <a href="<?php echo e(route('superadmin.students.export-face-registration')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Export CSV</a>
    </div>
  </div>
...
<?php echo $__env->make('superadmin.face_registration_modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\face_registration_management.blade.php ENDPATH**/ ?>