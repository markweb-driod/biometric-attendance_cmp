...
<div class="min-h-screen py-4 px-3 sm:px-4 md:px-6">
  <div class="max-w-lg mx-auto">
    ...
    <div class="text-center mb-6 sm:mb-8">
      ...
      <h1 class="text-2xl font-bold text-gray-900 mb-2">Face Registration</h1>
      <p class="text-gray-600 text-sm">Register your face for attendance</p>
    </div>
    ...
    <div id="step3-card" class="card p-4 sm:p-6 hidden">
      ...
      <form id="register-face-form" method="POST" action="<?php echo e(route('student.register-face')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('js/face-api.min.js')); ?>"></script>
<script>
document.addEventListener('DOMContentLoaded', async function() {
  ...
  // AI Settings
  const aiSettings = <?php echo json_encode($currentSettings ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\student\register_face.blade.php ENDPATH**/ ?>