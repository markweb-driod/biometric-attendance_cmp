...
<?php $__env->startSection('page-description', 'Manage your profile and all system settings'); ?>
...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
            ...
            <form class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" class="form-input" value="<?php echo e($user->full_name ?? 'Superadmin'); ?>">
                    </div>
                    <div>
                        <label class="form-label">Email</label>
                        <input type="email" class="form-input" value="<?php echo e($user->email ?? 'superadmin@nsuk.edu.ng'); ?>">
                    </div>
                </div>
    ...
    <section class="bg-white rounded-2xl shadow-xl border border-green-200 p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex gap-3">
                <?php if($has2FA): ?>
                    <form action="<?php echo e(route('superadmin.2fa.disable')); ?>" method="POST" id="disable-2fa-form" class="flex-1">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-4">
                            <div>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('superadmin.2fa.setup')); ?>" class="flex-1 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-semibold text-center transition-colors flex items-center justify-center">
            ...
            <form id="academic-settings-form">
                ...
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="class_duration_minutes" class="form-input" value="<?php echo e($settings['academic']['class_duration_minutes'] ?? 60); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Attendance Tolerance (minutes)</label>
                        <input type="number" name="attendance_tolerance_minutes" class="form-input" value="<?php echo e($settings['academic']['attendance_tolerance_minutes'] ?? 15); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Max Absence Threshold</label>
                        <input type="number" name="max_absence_threshold" class="form-input" value="<?php echo e($settings['academic']['max_absence_threshold'] ?? 10); ?>">
                    </div>
                </div>
                <div class="flex justify-end gap-2">
    ...
    <div class="settings-section">
        ...
        <div class="settings-content">
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('superadmin.face-config.update')); ?>" id="face-config-form">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label class="form-label">Face Provider</label>
                    <select name="face_provider" id="face_provider_select" class="form-select">
                        <option value="faceplusplus" <?php echo e(($provider ?? '') == 'faceplusplus' ? 'selected' : ''); ?>>Face++</option>
                        <option value="aws" <?php echo e(($provider ?? '') == 'aws' ? 'selected' : ''); ?>>AWS Rekognition</option>
                        <option value="azure" <?php echo e(($provider ?? '') == 'azure' ? 'selected' : ''); ?>>Azure Face API</option>
                    </select>
                </div>
                ...
                <div class="provider-fields" id="faceplusplus-fields">
                    <div class="grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="faceplusplus_api_key" id="faceplusplus_api_key" class="form-input" value="<?php echo e($apiKey ?? ''); ?>" placeholder="Face++ API Key">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Face++ API Secret</label>
                            <input type="text" name="faceplusplus_api_secret" id="faceplusplus_api_secret" class="form-input" value="<?php echo e($apiSecret ?? ''); ?>" placeholder="Face++ API Secret">
                        </div>
                    </div>
            ...
            <form id="biometric-settings-form">
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <div class="relative">
                            <input type="number" name="face_confidence_threshold" id="confidence_threshold" class="form-input" value="<?php echo e($settings['biometric']['face_confidence_threshold'] ?? 75); ?>" min="0" max="100" step="1">
                            <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-sm text-gray-500">
                                <span id="threshold_indicator"><?php echo e($settings['biometric']['face_confidence_threshold'] ?? 75); ?>%</span>
                            </div>
                        </div>
                        <div class="mt-2">
                            <input type="range" id="confidence_slider" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider" min="0" max="100" value="<?php echo e($settings['biometric']['face_confidence_threshold'] ?? 75); ?>" style="background: linear-gradient(to right, #ef4444 0%, #f59e0b 50%, #10b981 100%);">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="face_image_quality_threshold" class="form-input" value="<?php echo e($settings['biometric']['face_image_quality_threshold'] ?? 50); ?>" min="0" max="100">
                    ...
                    <div class="form-group">
                        ...
                        <select name="face_detection_sensitivity" class="form-select">
                            ...
                            <option value="medium" <?php echo e(($settings['biometric']['face_detection_sensitivity'] ?? 'medium') == 'medium' ? 'selected' : ''); ?>>Medium - Balanced detection</option>
                ...
                <div class="border-t border-gray-200 pt-4 mt-4">
                    ...
                    <div class="grid-2">
                        <div class="form-group">
                            ...
                            <div class="flex items-center mt-2">
                                <input type="checkbox" name="enable_browser_face_detection" class="form-checkbox" <?php echo e(($settings['biometric']['enable_browser_face_detection'] ?? true) ? 'checked' : ''); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex items-center mt-2">
                                <input type="checkbox" name="browser_face_allow_loose_alignment" class="form-checkbox" <?php echo e(($settings['biometric']['browser_face_allow_loose_alignment'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="browser_face_confidence_threshold" class="form-input" value="<?php echo e($settings['biometric']['browser_face_confidence_threshold'] ?? 0.5); ?>" min="0.1" max="0.9" step="0.05">
            ...
            <form id="security-settings-form">
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="password_min_length" class="form-input" value="<?php echo e($settings['security']['password_min_length'] ?? 8); ?>" min="6" max="20">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Session Timeout (minutes)</label>
                        <input type="number" name="session_timeout_minutes" class="form-input" value="<?php echo e($settings['security']['session_timeout_minutes'] ?? 120); ?>" min="30" max="480">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Max Login Attempts</label>
                        <input type="number" name="max_login_attempts" class="form-input" value="<?php echo e($settings['security']['max_login_attempts'] ?? 5); ?>" min="3" max="10">
                    </div>
                </div>
                <div class="grid-2">
                    <div class="form-group">
                        <label class="form-label">Lockout Duration (minutes)</label>
                        <input type="number" name="lockout_duration_minutes" class="form-input" value="<?php echo e($settings['security']['lockout_duration_minutes'] ?? 15); ?>" min="5" max="60">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Require 2FA</label>
                        <div class="flex items-center mt-2">
                            <input type="checkbox" name="require_2fa" class="form-checkbox" <?php echo e(($settings['security']['require_2fa'] ?? false) ? 'checked' : ''); ?>>
            ...
            <form id="notification-settings-form">
                <div class="grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="smtp_port" class="form-input" value="<?php echo e($settings['notifications']['smtp_port'] ?? 587); ?>">
                    </div>
                </div>
                <div class="grid-2">
                    <div class="form-group">
                ...
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <select name="smtp_encryption" class="form-select">
                            <option value="tls" <?php echo e(($settings['notifications']['smtp_encryption'] ?? 'tls') == 'tls' ? 'selected' : ''); ?>>TLS</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="from_name" class="form-input" value="<?php echo e($settings['notifications']['from_name'] ?? 'NSUK Attendance System'); ?>">
                    </div>
                </div>
                <div class="flex justify-end gap-2">
            ...
            <form id="performance-settings-form">
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="cache_duration_minutes" class="form-input" value="<?php echo e($settings['performance']['cache_duration_minutes'] ?? 60); ?>" min="5" max="1440">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Max Upload Size (MB)</label>
                        <input type="number" name="max_upload_size_mb" class="form-input" value="<?php echo e($settings['performance']['max_upload_size_mb'] ?? 10); ?>" min="1" max="100">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Image Quality (%)</label>
                        <input type="number" name="image_compression_quality" class="form-input" value="<?php echo e($settings['performance']['image_compression_quality'] ?? 80); ?>" min="10" max="100">
                    </div>
                </div>
                <div class="flex justify-end gap-2">
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\settings.blade.php ENDPATH**/ ?>