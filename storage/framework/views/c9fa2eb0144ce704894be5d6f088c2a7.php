        ...
        <div class="bg-white rounded-3xl shadow-xl border border-purple-200 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <?php if($has2FA): ?>
                        <form action="<?php echo e(route('hod.two-factor.disable')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="space-y-3">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('hod.two-factor.setup')); ?>" class="block w-full px-4 py-2 text-sm font-semibold text-center text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors">
                            Enable 2FA
                        </a>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('hod.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\hod\settings\index.blade.php ENDPATH**/ ?>