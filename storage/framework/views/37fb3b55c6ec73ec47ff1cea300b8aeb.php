...
<?php $__env->startSection('title', 'Session Monitoring'); ?>
<?php $__env->startSection('page-title', 'Session Monitoring'); ?>
<?php $__env->startSection('page-description', 'Monitor all active sessions and view session history'); ?>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900" id="stat-active"><?php echo e($stats['active_sessions'] ?? 0); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900" id="stat-superadmin"><?php echo e($stats['active_superadmin'] ?? 0); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900" id="stat-lecturers"><?php echo e($stats['active_lecturers'] ?? 0); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-orange-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900" id="stat-hods"><?php echo e($stats['active_hods'] ?? 0); ?></p>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow-lg p-4 sm:p-6 border-l-4 border-indigo-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($stats['recent_stats']['total_sessions'] ?? 0); ?></p>
                </div>
...
async function loadLiveSessions() {
    try {
        ...
        let url = '<?php echo e(route("superadmin.session-monitoring.live")); ?>?page=1';
...
async function loadSessionHistory(page = 1) {
    try {
        ...
        let url = '<?php echo e(route("superadmin.session-monitoring.history")); ?>?page=' + page;
        if (userType) url += '&user_type=' + encodeURIComponent(userType);
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\superadmin\session-monitoring\index.blade.php ENDPATH**/ ?>