...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Superadmin Portal'); ?> - NSUK Biometric Attendance</title>
...
<body class="bg-gray-50 min-h-screen font-sans antialiased" style="font-family: 'Montserrat', sans-serif;" 
    ...
    <div class="pt-16 transition-all duration-300 ease-in-out" 
        ...
        <?php echo $__env->make('components.superadmin-navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\layouts\superadmin.blade.php ENDPATH**/ ?>