...
<body class="bg-gray-50 flex flex-col min-h-screen font-sans antialiased text-gray-900">
    ...
    <nav class="bg-white border-b border-green-100 shadow-sm fixed top-0 w-full z-50 backdrop-blur-md bg-opacity-90 transition-all duration-300" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between relative">
            ...
            >
                ...
                <a href="<?php echo e(route('student.register-face.form')); ?>" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base font-semibold rounded-lg shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="flex-1 flex flex-col items-center w-full px-2 sm:px-4 pb-4 relative">
        ...
        <div class="w-full flex flex-col items-center mt-2 sm:mt-4">
            <div class="<?php echo $__env->yieldContent('wrapper_class', 'w-full max-w-lg sm:max-w-xl bg-gradient-to-br from-white via-green-50 to-green-100 rounded-2xl shadow-lg border border-green-100 p-2 sm:p-6 mt-2 sm:mt-4'); ?>" style="<?php echo $__env->yieldContent('wrapper_style', 'backdrop-filter: blur(0.5px);'); ?>">
