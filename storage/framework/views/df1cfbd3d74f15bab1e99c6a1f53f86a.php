...
<div class="min-h-screen bg-gray-50">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('hod.dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('hod.management.students.index')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Student Management</a>
                    </div>
                </li>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div class="flex items-center space-x-6">
                <div class="relative">
                    <?php if($student->reference_image_path): ?>
                        <img src="<?php echo e(asset('storage/' . $student->reference_image_path)); ?>" 
                             alt="<?php echo e($student->user->full_name); ?>" 
                             class="h-20 w-20 sm:h-28 sm:w-28 rounded-full object-cover border-4 border-blue-200 shadow-lg">
                    <?php else: ?>
                        <div class="h-20 w-20 sm:h-28 sm:w-28 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-lg border-4 border-blue-200">
                            <span class="text-xl sm:text-2xl font-bold text-white"><?php echo e(substr($student->user->full_name, 0, 2)); ?></span>
                        </div>
                    <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-2 sm:gap-4 mt-2">
                        <span class="px-3 py-1 bg-blue-100 text-blue-800 text-xs sm:text-sm font-semibold rounded-full">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('hod.management.students.index')); ?>" class="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    ...
                    <span class="text-sm text-gray-900 font-medium"><?php echo e($student->user->full_name); ?></span>
                </div>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    <span class="text-sm font-medium text-gray-500">Matric Number</span>
                    <span class="text-sm font-mono text-gray-900 font-medium"><?php echo e($student->matric_number); ?></span>
                </div>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    ...
                    <span class="text-sm text-gray-900 font-medium"><?php echo e($student->classrooms->count()); ?></span>
                </div>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    <span class="text-sm font-medium text-gray-500">Total Attendance Records</span>
                    <span class="text-sm text-gray-900 font-medium"><?php echo e($attendanceStats->total_records ?? 0); ?></span>
                </div>
                <?php endif; ?>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-6">
        ...
        <div class="bg-gray-50 rounded-lg p-6 flex flex-col items-center">
            <div class="relative mb-4">
                <img src="<?php echo e(asset('storage/' . $student->reference_image_path)); ?>" 
                     alt="<?php echo e($student->user->full_name); ?> - Registered Image" 
                     class="max-w-full h-auto rounded-lg shadow-lg border-4 border-white"
                     style="max-height: 400px; max-width: 100%;">
                <?php if($student->face_registration_enabled): ?>
                    <div class="absolute top-4 right-4 bg-green-500 rounded-full px-3 py-1 flex items-center space-x-2 shadow-lg">
                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span class="text-xs font-semibold text-white">Registered</span>
                    </div>
                <?php endif; ?>
            </div>
            <p class="text-sm text-gray-600 mt-2">This is the student's registered biometric image used for attendance verification</p>
        </div>
    </div>
    <?php else: ?>
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-6">
        ...
        <div class="bg-gray-50 rounded-lg p-12 flex flex-col items-center justify-center">
            <svg class="w-16 h-16 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg>
            <p class="text-gray-600 font-medium">No registered image available</p>
            <p class="text-sm text-gray-500 mt-2">This student has not registered a biometric image yet</p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                <p class="text-sm text-blue-600 font-medium mb-1">Total Records</p>
                <p class="text-2xl font-bold text-blue-900"><?php echo e($attendanceStats->total_records ?? 0); ?></p>
            </div>
            <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                <p class="text-sm text-green-600 font-medium mb-1">Present</p>
                <p class="text-2xl font-bold text-green-900"><?php echo e($attendanceStats->present_count ?? 0); ?></p>
            </div>
            <div class="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                <p class="text-sm text-red-600 font-medium mb-1">Absent</p>
                <p class="text-2xl font-bold text-red-900"><?php echo e($attendanceStats->absent_count ?? 0); ?></p>
            </div>
            <div class="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
                <p class="text-sm text-yellow-600 font-medium mb-1">Late</p>
                <p class="text-2xl font-bold text-yellow-900"><?php echo e($attendanceStats->late_count ?? 0); ?></p>
            </div>
        </div>
        <?php if($attendanceStats->total_records > 0): ?>
        <div class="mt-4">
            <?php
            ...
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-sm font-semibold text-gray-900"><?php echo e(number_format($attendanceRate, 1)); ?>%</span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-2.5">
                <div class="bg-blue-600 h-2.5 rounded-full" style="width: <?php echo e(min(100, $attendanceRate)); ?>%"></div>
            </div>
        </div>
        <?php endif; ?>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                ...
                <div class="space-y-2 text-sm text-gray-600">
                    ...
                    <div class="flex justify-between">
                        <span>Lecturer:</span>
                        <span class="font-medium"><?php echo e($classroom->lecturer->user->full_name ?? 'N/A'); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span>PIN:</span>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
        <div class="flex flex-wrap gap-3 justify-center">
            <button onclick="openEditModal(<?php echo e($student->id); ?>)" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                </svg>
                Edit Student
            </button>
            <a href="<?php echo e(route('hod.monitoring.students')); ?>?student=<?php echo e($student->id); ?>" class="inline-flex items-center px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
                View Attendance Report
            </a>
            <button onclick="confirmDelete(<?php echo e($student->id); ?>)" class="inline-flex items-center px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-lg bg-white">
        <div class="mt-3">
            ...
            <div class="flex space-x-3">
                <a href="<?php echo e(route('hod.management.students.index')); ?>" class="flex-1 text-center bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition">Go to Management</a>
...
function confirmDelete(id) {
    if (confirm('Are you sure you want to delete this student? This action cannot be undone.')) {
        fetch(`<?php echo e(route("hod.management.students.api.delete", ":id")); ?>`.replace(':id', id), {
            method: 'DELETE',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = '<?php echo e(route("hod.management.students.index")); ?>';
            } else {
...
<?php echo $__env->make('hod.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\biometric-attendance\resources\views\hod\management\students\show.blade.php ENDPATH**/ ?>