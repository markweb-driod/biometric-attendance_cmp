...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                <div class="info-item">
                    ...
                    <span class="info-value">{{ $student->user->full_name ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Matric Number:</span>
                    <span class="info-value">{{ $student->matric_number ?? 'N/A' }}</span>
                </div>
                <div class="info-item">
                    <span class="info-label">Registration Date:</span>
                    <span class="info-value">{{ now()->format('l, F j, Y \a\t g:i A') }}</span>
                </div>
                <div class="info-item">
        ...
        <div class="footer">
            ...
            <p>&copy; {{ date('Y') }} NSUK Biometric Attendance System. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
