...
<body class="bg-gray-50">
    ...
    @endif
    <!-- Sidebar -->
    <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-60 bg-green-600 shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <!-- Logo Section -->
        <div class="flex flex-col items-center justify-center py-4 border-b border-green-700">
        ...
        <nav class="mt-10 px-2">
            ...
            <div class="px-3 mt-16">
                <p class="text-sm font-bold text-white uppercase tracking-wider mb-2">Quick Actions</p>
                <div class="space-y-1">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-2 border-t border-green-700">
            <div class="flex items-center space-x-2">
                ...
                <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-white truncate" id="userDepartment">Computer Science</p>
                </div>
                    <button id="userMenuButton" class="text-white hover:text-white">
