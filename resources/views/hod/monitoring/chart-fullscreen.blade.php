...
<head>
    ...
    <title>{{ $chartTitle }} - Full Screen</title>
...
<body class="min-h-screen">
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-l-4 border-green-500">
            <div class="flex justify-between items-center flex-wrap gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-green-800">{{ $chartTitle }}</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800">{{ $chartTitle }}</h2>
    ...
    <script>
        ...
        const chartConfig = {!! json_encode($chartData) !!};
