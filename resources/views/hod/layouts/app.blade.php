...
<head>
    ...
    <title>@yield('title', 'HOD Portal') - {{ config('app.name', 'Biometric Attendance') }}</title>
...
<body class="font-sans antialiased bg-gray-50" style="font-family: 'Montserrat', sans-serif;" 
      ...
      ">
    <!-- Navbar -->
    @include('hod.components.navbar')
    
        <!-- Sidebar -->
    @include('hod.components.sidebar')

    <!-- Mobile Menu Button -->
    @include('hod.components.mobile-menu')
