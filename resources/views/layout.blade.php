    ...
    <nav class="bg-white border-b border-green-100 shadow-sm fixed top-0 w-full z-50 backdrop-blur-md bg-opacity-90 transition-all duration-300" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between relative">
            ...
            <div 
                ...
                class="absolute top-16 left-0 w-full sm:relative sm:top-0 sm:w-auto sm:flex bg-white sm:bg-transparent border-b border-green-100 sm:border-0 shadow-lg sm:shadow-none py-4 sm:py-0 px-4 sm:px-0 flex-col sm:flex-row items-center gap-3 sm:gap-4 transition-all duration-200 z-40" 
                x-cloak
            >
