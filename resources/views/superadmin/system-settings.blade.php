...
@section('page-description', 'Configure all system settings and preferences')

@push('styles')
<link rel="stylesheet" href="{{ asset('css/global-optimized.css') }}">
<style>
    .settings-section {
        background: white;
        border-radius: 12px;
            ...
            <form id="academic-settings-form">
                ...
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="class_duration_minutes" class="form-input" value="{{ $settings['academic']['class_duration_minutes'] }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Attendance Tolerance (minutes)</label>
                        <input type="number" name="attendance_tolerance_minutes" class="form-input" value="{{ $settings['academic']['attendance_tolerance_minutes'] }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Max Absence Threshold</label>
                        <input type="number" name="max_absence_threshold" class="form-input" value="{{ $settings['academic']['max_absence_threshold'] }}">
                    </div>
                </div>
                <div class="flex justify-end gap-2">
            ...
            <form id="biometric-settings-form">
                <div class="form-group">
                    ...
                    <select name="face_provider" class="form-select">
                        <option value="faceplusplus" {{ $settings['biometric']['face_provider'] == 'faceplusplus' ? 'selected' : '' }}>Face++</option>
                    </select>
                </div>
                <div class="grid-2">
                    <div class="form-group">
                        <label class="form-label">Face++ API Key</label>
                        <input type="text" name="faceplusplus_api_key" class="form-input" value="{{ $settings['biometric']['faceplusplus_api_key'] }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Face++ API Secret</label>
                        <input type="password" name="faceplusplus_api_secret" class="form-input" value="{{ $settings['biometric']['faceplusplus_api_secret'] }}">
                    </div>
                </div>
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <div class="relative">
                            <input type="number" name="face_confidence_threshold" id="confidence_threshold" class="form-input" value="{{ $settings['biometric']['face_confidence_threshold'] }}" min="0" max="100" step="1">
                            <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-sm text-gray-500">
                                <span id="threshold_indicator">{{ $settings['biometric']['face_confidence_threshold'] }}%</span>
                            </div>
                        </div>
                        <div class="mt-2">
                            <input type="range" id="confidence_slider" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer slider" min="0" max="100" value="{{ $settings['biometric']['face_confidence_threshold'] }}" style="background: linear-gradient(to right, #ef4444 0%, #f59e0b 50%, #10b981 100%);">
                        ...
                        <div class="mt-2 text-xs text-gray-600">
                            <div class="flex items-center gap-2">
                                ...
                                <span id="threshold_description">Current setting: {{ $settings['biometric']['face_confidence_threshold'] >= 80 ? 'Very Strict - High security, may reject valid faces' : ($settings['biometric']['face_confidence_threshold'] >= 60 ? 'Balanced - Good security and usability' : 'Loose - Lower security, more permissive') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Image Quality Threshold (%)</label>
                        <input type="number" name="face_image_quality_threshold" class="form-input" value="{{ $settings['biometric']['face_image_quality_threshold'] }}" min="0" max="100">
                    ...
                    <div class="form-group">
                        ...
                        <select name="face_detection_sensitivity" class="form-select">
                            ...
                            <option value="medium" {{ $settings['biometric']['face_detection_sensitivity'] == 'medium' ? 'selected' : '' }}>Medium - Balanced detection</option>
            ...
            <form id="security-settings-form">
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="password_min_length" class="form-input" value="{{ $settings['security']['password_min_length'] }}" min="6" max="20">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Session Timeout (minutes)</label>
                        <input type="number" name="session_timeout_minutes" class="form-input" value="{{ $settings['security']['session_timeout_minutes'] }}" min="30" max="480">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Max Login Attempts</label>
                        <input type="number" name="max_login_attempts" class="form-input" value="{{ $settings['security']['max_login_attempts'] }}" min="3" max="10">
                    </div>
                </div>
                <div class="grid-2">
                    <div class="form-group">
                        <label class="form-label">Lockout Duration (minutes)</label>
                        <input type="number" name="lockout_duration_minutes" class="form-input" value="{{ $settings['security']['lockout_duration_minutes'] }}" min="5" max="60">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Require 2FA</label>
                        <div class="flex items-center mt-2">
                            <input type="checkbox" name="require_2fa" class="form-checkbox" {{ $settings['security']['require_2fa'] ? 'checked' : '' }}>
            ...
            <form id="notification-settings-form">
                <div class="grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="smtp_port" class="form-input" value="{{ $settings['notifications']['smtp_port'] }}">
                    </div>
                </div>
                <div class="grid-2">
                    <div class="form-group">
                ...
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <select name="smtp_encryption" class="form-select">
                            <option value="tls" {{ $settings['notifications']['smtp_encryption'] == 'tls' ? 'selected' : '' }}>TLS</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="from_name" class="form-input" value="{{ $settings['notifications']['from_name'] }}">
                    </div>
                </div>
                <div class="flex justify-end gap-2">
            ...
            <form id="performance-settings-form">
                <div class="grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="cache_duration_minutes" class="form-input" value="{{ $settings['performance']['cache_duration_minutes'] }}" min="5" max="1440">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Max Upload Size (MB)</label>
                        <input type="number" name="max_upload_size_mb" class="form-input" value="{{ $settings['performance']['max_upload_size_mb'] }}" min="1" max="100">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Image Quality (%)</label>
                        <input type="number" name="image_compression_quality" class="form-input" value="{{ $settings['performance']['image_compression_quality'] }}" min="10" max="100">
                    </div>
                </div>
                <div class="flex justify-end gap-2">
...
// Simplified confidence threshold management
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (confidenceInput && confidenceSlider && thresholdIndicator && thresholdDescription) {
        // Simple sync without complex display updates
...
// Add preset buttons to the form - REMOVED TO PREVENT TIMEOUT ISSUES
</script>
@endpush
