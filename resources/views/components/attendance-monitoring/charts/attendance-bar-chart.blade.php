...
<div class="attendance-bar-chart-container">
    ...
    <!-- Chart Loading State -->
    <div id="{{ $chartId }}-loading" class="flex items-center justify-center bg-gray-50 rounded-lg" style="height: {{ $height }}px;">
    ...
    <!-- Chart Error State -->
    <div id="{{ $chartId }}-error" class="hidden flex items-center justify-center bg-red-50 rounded-lg border border-red-200" style="height: {{ $height }}px;">
        <div class="text-center">
            ...
            <button 
                onclick="retryChartLoad('{{ $chartId }}')" 
    ...
    <!-- Chart Container -->
    <div id="{{ $chartId }}-container" class="hidden">
        <canvas 
            id="{{ $chartId }}" 
            class="w-full"
    ...
    <div id="{{ $chartId }}-info" class="hidden mt-4 p-4 bg-gray-50 rounded-lg">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            <div class="text-center">
                <div class="font-semibold text-gray-900" id="{{ $chartId }}-total-sessions">-</div>
                <div class="text-gray-600">Total Sessions</div>
            </div>
            <div class="text-center">
                <div class="font-semibold text-green-600" id="{{ $chartId }}-avg-attendance">-</div>
                <div class="text-gray-600">Average Attendance</div>
            </div>
            <div class="text-center">
                <div class="font-semibold text-blue-600" id="{{ $chartId }}-trend">-</div>
...
<div id="{{ $chartId }}-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900" id="{{ $chartId }}-modal-title">Detailed View</h3>
                    <button 
                        onclick="closeChartModal('{{ $chartId }}')"
                ...
                <div id="{{ $chartId }}-modal-content" class="space-y-4">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function initChart() {
            if (typeof AttendanceBarChart !== 'undefined') {
                ...
                window.attendanceCharts['{{ $chartId }}'] = new AttendanceBarChart(chartConfig);
            } else {
